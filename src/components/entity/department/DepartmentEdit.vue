      ...
      <el-tab-pane label="基础">
        ...
        >
          <el-row>
            ...
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
              <el-form-item label="负责人" required prop="thoseResponsible">
                <el-input v-model="formData.thoseResponsible" size="mini" />
              </el-form-item>
            </el-col>
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
              <el-form-item label="类型" required prop="type">
                <DepartmentTypeEnumSelect v-model="formData.type" />
              </el-form-item>
            </el-col>
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
    ...
    async save() {
      return new Promise((resolve, reject) => {
        this.$refs['formData'].validate(async valid => {
          if (valid) {
            if (this.formData.id) {
              await departmentServer.put(this.formData)
            } else {
              const res = await departmentServer.post(this.formData)
