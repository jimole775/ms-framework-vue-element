      ...
      <el-tab-pane label="基础">
        ...
        >
          <el-row>
            ...
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
              <el-form-item label="型号" required prop="type">
                <el-input v-model="formData.type" size="mini" />
              </el-form-item>
            </el-col>
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
    ...
    async save() {
      return new Promise((resolve, reject) => {
        this.$refs['formData'].validate(async valid => {
          if (valid) {
            if (this.formData.id) {
              await machineTypeServer.put(this.formData)
            } else {
              const res = await machineTypeServer.post(this.formData)
