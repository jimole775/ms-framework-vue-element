      ...
      <div class="max-w">
        ...
        >
          <el-row>
            ...
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
              <el-form-item v-if="!search" label="进货港名称">
                <el-input v-model="keyword.seaportInName" size="mini"/>
              </el-form-item>
            </el-col>
            <el-col :lg="6" :md="8" :sm="12" :xs="24">
              <el-form-item v-if="!search" label="出货港名称">
                <el-input v-model="keyword.seaportOutName" size="mini"/>
              </el-form-item>
            </el-col>
...
export default {
  name: 'ShipmentNoticeSelectPopup',
  filters: {
    shiptypeFilter(val) {
      switch (val) {
        case 1:
  ...
  methods: {
    ...
    async search() {
      ...
      try {
        const res = await shipmentNoticeServer.search_without_entid({
          query,
          page: this.page,
          size: this.size
        })
