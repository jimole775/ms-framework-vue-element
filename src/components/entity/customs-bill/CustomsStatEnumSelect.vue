...
import CustomsBillCustomsStatusEnumUtil from './../../enum/customs-bill/CustomsBillCustomsStatusEnumUtil'

export default {
  name: 'CustomsStatEnumSelect',
  props: {
    value: {
  ...
  data() {
    return {
      list: [
        {
          id: null,
          title: CustomsBillCustomsStatusEnumUtil.toTitle(null)
        },
        {
          id: '00',
