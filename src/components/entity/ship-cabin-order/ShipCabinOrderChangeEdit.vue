        ...
        <el-tabs v-loading="loading" tab-position="top">
          <el-tab-pane label="基础信息">
            <el-row>              
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="原订舱单号" prop="oldBookingNo">
                  <el-input v-model="formData.oldBookingNo" :disabled="true" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="新订舱单号" prop="bookingNo">
                  <el-input v-model="formData.bookingNo" :disabled="true" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item v-if="!(formData.shipType === 3 || formData.shipType === 6 || formData.shipType === 5 || formData.shipType === 1)" label="变更类型" prop="isChange">
                  <ChangeLeTypeSelect v-model="formData.isChange" :disabled="isDisable1"/>
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <!-- <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="物流状态" prop="logState">
                  <ShipCabinOrderLogStatusEnumSelect v-model="formData.logState" :disabled="true" />
                </el-form-item>
              </el-col> -->
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item v-if="isInnerUser" label="客户编码" prop="custCode">
                  <el-input v-model="formData.custCode" :disabled="true" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item v-if="isInnerUser" label="客户名称" prop="custName">
              ...
              <el-col :sm="12" :xs="24">
                <el-form-item label="箱号" prop="actualBoxNos">
                  <el-input :disabled="authProcess7" v-model="formData.actualBoxNos" size="mini"/>
                </el-form-item>
              </el-col>
              <el-col :sm="12" :xs="24">
                <el-form-item label="空箱重量" prop="emptyBoxWeight">
                  <el-input :disabled="authProcess7" v-model="formData.emptyBoxWeight" size="mini"/>
                </el-form-item>
              </el-col>
              <el-col :sm="12" :xs="24">
                <el-form-item label="封号" prop="seals">
                  <el-input :disabled="authProcess7" v-model="formData.seals" size="mini"/>
                </el-form-item>
              </el-col>
              <el-col :span="24">
              ...
              <el-col :span="24">
                <el-form-item label="变更备注" prop="cNote">
                  <el-input
                    v-model="formData.cNote"
                    :disabled="isDisable1"
                    :rows="4"
                    type="textarea"
                    size="mini"
            ...
            <FileUpload
              :id="formData.oldBookingId"
              :bill-name="'订舱单流水号'" /> 
          </el-tab-pane>
          <el-tab-pane v-if="isInnerUser" label="单据需求">
                ...
                <el-row>
                  ...
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="企业编码" prop="consignorCompanyCode">
                      <el-input v-model="formData.consignorCompanyCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="国家代码" prop="consignorCountryCode">
                      <el-input v-model="formData.consignorCountryCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                ...
                <el-row>
                  ...
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="企业编码" prop="consigneeCompanyCode">
                      <el-input v-model="formData.consigneeCompanyCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="企业名称" prop="consigneeCompanyCodeName">
                      <el-input v-model="formData.consigneeCompanyCodeName" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="国家代码" prop="consigneeCountryCode">
                      <el-input v-model="formData.consigneeCountryCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                  ...
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="具体联系人" prop="particularConsigneeName">
                      <el-input v-model="formData.particularConsigneeName" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="具体联系电话" prop="particularConsigneePhone">
                      <el-input v-model="formData.particularConsigneePhone" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="具体联系传真" prop="particularConsigneeFax">
                      <el-input v-model="formData.particularConsigneeFax" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="具体联系邮箱" prop="particularConsigneeEMail">
                      <el-input v-model="formData.particularConsigneeEMail" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-collapse-item>
                ...
                <el-row>
                  ...
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="企业编码" prop="noticeManCompanyCode">
                      <el-input v-model="formData.noticeManCompanyCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
                    <el-form-item label="国家代码" prop="noticeManCountryCode">
                      <el-input v-model="formData.noticeManCountryCode" :disabled="true" size="mini" />
                    </el-form-item>
                  </el-col>
                  <el-col :lg="6" :md="8" :sm="12" :xs="24">
          ...
          <el-tab-pane label="船务信息">
            <el-row>
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="协议货代" prop="transitId">
                  <ShippingCompanySelect 
                    :disabled="isDisable1 === true && isDisabled_for_transit === true"
                    v-model="formData.transitId"
                    :form="1"
                    :hd-type="1" 
                    @changeData="changeProtocal"/>
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="指定货代公司" prop="logisticsId">
                  <ShippingCompanySelect 
                    :disabled="isDisable1 === true"
                    v-model="formData.logisticsId"
                    :form="1"
                    :hd-type="2"
                    @changeData="changeHDC" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="船公司" prop="towCopName">
                  <el-input 
                    :disabled="authProcess2 && authProcess3 && authProcess6"  
                    v-model="formData.towCopName" 
                    size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="船名" prop="shipName">
                  <el-input :disabled="authProcess2 && authProcess3 && authProcess6" v-model="formData.shipName" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="船次" prop="saillings">
                  <el-input :disabled="authProcess2 && authProcess3 && authProcess6" v-model="formData.saillings" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="提单号" prop="billNo">
                  <el-input :disabled="authProcess2 && authProcess3 && authProcess6" v-model="formData.billNo" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="开船日期" prop="departDate">
                  <el-date-picker
                    :disabled="authProcess2 && authProcess3 && authProcess4"
              ...
              <!--<el-input v-model="formData.customsBroker" :disabled="true" size="mini" />-->
              <!--</el-form-item>-->
              <!--</el-col>-->
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
              ...
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="是否报关" prop="isBg">
                  <el-switch :disabled="isDisable1 === true" v-model="formData.isBg" size="mini" />
                </el-form-item>
              </el-col>
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
                <el-form-item label="是否放舱" prop="isFc">
                  <el-switch :disabled="authProcess2 && authProcess6" v-model="formData.isFc" size="mini" />
                </el-form-item>
              </el-col>
              <!--<el-col :lg="6" :md="8" :sm="12" :xs="24">-->
              <!--<el-form-item label="出境关别" prop="exitCustomsName">-->
              <!--<el-input v-model="formData.exitCustomsName" :disabled="true" size="mini" />-->
              <!--</el-form-item>-->
              <!--</el-col>-->
              <el-col :lg="6" :md="8" :sm="12" :xs="24">
            ...
            <el-table :data="containerList">
              <el-table-column type="expand">
                <template slot-scope="props">
                  <div>
                    <div>
                      总毛重:{{ props.row.totalUnitGw }}
                      &nbsp;&nbsp;
                      总净重:{{ props.row.totalUnitNw }}
                      &nbsp;&nbsp;
                      总体积:{{ props.row.totalPackRule }}
                      &nbsp;&nbsp;
                      总件数:{{ props.row.totalXqty }}
                    </div>
                    <el-table :data="props.row.lineList" class="m-t-6">
                      <el-table-column
                        type="index"
                        width="50"
                      />
              ...
              />
              <el-table-column
                property="totalPackRule"
                label="总体积"
                min-width="120"
              />
              <el-table-column
                property="totalUnitGw"
                label="总毛重"
                min-width="120"
              />
              <el-table-column
                property="totalUnitNw"
                label="总件数"
                min-width="120"
              />
              <el-table-column
          ...
          <el-tab-pane label="拖柜计划">
            <el-table :data="getContainerProjectList">
              ...
              >
                <template slot-scope="scope">
                  {{ parseInt(scope.row.entId) | OperaUnitFilter }}
                </template>
              </el-table-column>
              <el-table-column
                property="warnNo"
              ...
              >
                <template slot-scope="scope">
                  {{ scope.row.dateAm === '1' ? '是' : scope.row.dateAm === '0' ? '否' : scope.row.dateAm }}
                </template>
              </el-table-column>
              <el-table-column
                property="datePm"
              ...
              >
                <template slot-scope="scope">
                  {{ scope.row.datePm === '1' ? '是' : scope.row.datePm === '0' ? '否' : scope.row.datePm }}
                </template>
              </el-table-column>
              <el-table-column
                property="dateEm"
                label="晚上(18:00-08:00)"
                min-width="130"
              >
                <template slot-scope="scope">
                  {{ scope.row.dateEm === '1' ? '是' : scope.row.dateEm === '0' ? '否' : scope.row.dateEm }}
                </template>
              </el-table-column>
              <el-table-column
                property="note"
...
import ChangeLeTypeSelect from './../../../components/entity/ship-cabin-order/ChangeLeTypeSelect'
...
export default {
  ...
  computed: {    
    ...
    isReorderType() {
       // this.formData.isChang === 3 变更类型为“重新订舱”
      return Number.parseInt(this.formData.isChange) === 3
    },    
    isUpdateShipping() {
       // this.formData.isChang === 2 变更类型为“变更船期”
      return Number.parseInt(this.formData.isChange) === 2
    }, 
    authProcess2() {      
      // 变更类型为“变更船期”时
      // 页面字段【船公司】、【船名】、【船次】、【提单号】、【开船日期】、【截关日期】、【截单日期】【是否放舱】可编辑
      return !(this.isUpdateShipping && Number.parseInt(this.curProcessOrder) === 2)
    },
    authProcess3() {      
      // 变更类型为“重新订舱”时
      // 页面字段【船公司】、【船名】、【船次】、【提单号】、【开船日期】、【截关日期】、【截单日期】可编辑
      // 其余字段置灰, 且【开船日期】、【截关日期】为必填项
      return !(this.isReorderType && Number.parseInt(this.curProcessOrder) === 3)
    },
    authProcess4() {
      // 变更类型为“重新订舱”时
      // 【开船日期】、【截关日期】可编辑，其余字段置灰
      return !(this.isReorderType && Number.parseInt(this.curProcessOrder) === 4)
    },
    authProcess6() {
      // 变更类型为“重新订舱”时
      // 【船公司】、【船名】、【船次】、【提单号】、【是否放舱】可编辑且是必填字段
      return !(this.isReorderType && Number.parseInt(this.curProcessOrder) === 6)
    },
    authProcess7() {
      // 变更类型为“重新订舱”时
      // 【箱号】、【封号】、【空箱重量】可编辑，且是必填字段
      return !(this.isReorderType && Number.parseInt(this.curProcessOrder) === 7)
    },
    hasMalfunction() {
  ...
  async created() {
    if (this.id) {
      ...
      if (this.formData.status === 10) { 
        this.$emit('changeIsStatus', this.formData.status)
      }
    } else {
      initFormData = {
        ...emptyFormData
  ...
  methods: {
    ...
    changeHDC(selectBill) {
      if (selectBill) {
        this.formData.relaman = selectBill.relaman
        this.formData.phone = selectBill.phone
        this.formData.email = selectBill.email  
        this.formData.logisticsCode = selectBill.supplierCode
        this.formData.logisticsName = selectBill.supplierName
      } else {
    ...
    changeProtocal(selectBill) {
      if (selectBill) {
        this.formData.transitRelaName = selectBill.relaman
        this.formData.transitCode = selectBill.supplierCode
        this.formData.transitName = selectBill.supplierName
        this.formData.transitPhone = selectBill.phone
        this.formData.transitEmail = selectBill.email
      } else {
    ...
    async getData() {
      ...
      const getContainerProjectRes = await shipCabinOrderServer.getContainerProject(res.data.warnInfo.warnNo, userTypeTo)
      ...
      const chageTypeRes = await currencyServer.search({ type: 'chageType' })
      this.chageType = chageTypeRes.data.data || {}
        ...
        this.$refs['formData'].validate(async valid => {
          if (valid) {
            ...
            if (this.formData.isChange !== 4) {
              if (this.formData.cutoffDate && this.formData.cutDate && 
                Date.parse(this.formData.cutoffDate) > 
                ((Date.parse(this.formData.cutDate) + (16 * 60 * 60 * 1000 - 1)))) {
                this.$message({
            ...
            if (this.formData.id) {
              await shipCabinOrderServer.put(this.formData)
            } else {
              const res = await shipCabinOrderServer.post(this.formData)
    ...
    async synchronizeLogisticsStatus() {
      if (this.formData.billNo !== null && this.formData.billNo !== '') {
        ...
        this.$message({
          message: '当前页面提单号为空，无法同步物流状态',
          type: 'warning'
        })
      }
    },
    async cancelTheChange() { // 取消变更
      const data = {
        bookingId: this.formData.bookingId,
        oldBookingId: this.formData.oldBookingId
      }
      this.$confirm('订舱单变更是否取消？', '提示', {
        ...
        .then(async() => {
          // 同意保存，执行保存动作
          try {
            await shipCabinOrderServer.cancelChange(data)
            this.$message({
              message: '取消变更成功！',
              type: 'success'
            }) 
    ...
    async newStartProcess() {
      return new Promise(async(resolve, reject) => {
        ...
        await this.getData()
        // 发运方式为  1、BY TRAIN    5、BYTRUCK BY   3、出差专用   6、 BY EXPRESS 且不需要报关的, 直接不走流程，订舱状态变成 '订舱完成'
        if ((this.formData.shipType === 3 || this.formData.shipType === 6 || this.formData.shipType === 1 || this.formData.shipType === 5) && this.formData.isBg === 1) {
        ...
        // 如果 this.formData.isChange 类型为 4，就不需要任何校验
        if (this.formData.isChange !== 4) {
          if (this.formData.cutDate && this.formData.preShipDate && 
            Date.parse(this.formData.cutDate) <= 
            Date.parse(this.formData.preShipDate)) {
            this.$message({
        ...
        // 以下是【重新订舱】状态时的流程
        if (this.isReorderType) {
          if (!this.formData.transitId) {
            if ([1, 3, 5, 6].indexOf(this.formData.shipType) === -1) {
              this.$message({
        ...
        this.$refs['formData'].validate(async valid => {    
          if (valid) {
            try {
              ...
              const res = await shipCabinOrderServer.put(this.formData)
              if (Number.parseInt(res.data.code) === 200) {
                ...
                // 发运方式为  1、BY TRAIN    5、BYTRUCK BY   3、出差专用   6、 BY EXPRESS 且不需要报关的, 直接不走流程，订舱状态变成 '订舱完成'                
                if ((this.formData.shipType === 3 || this.formData.shipType === 6 || this.formData.shipType === 1 || this.formData.shipType === 5) && this.formData.isBg === 1) {
                  const resData = await shipCabinOrderServer.changeStatus(this.formData)
    ...
    validAgreeProcess() {
      return new Promise(async(s, j) => {
        ...
        if (this.formData.departDate && this.formData.cutDate && 
            Date.parse(this.formData.departDate) <
            Date.parse(this.formData.cutDate)) {
          this.$message({
              message: '"开船日期" 不能小于 "截关日期"',
              type: 'warning'
            })  
            return j()
        }
        ...
        // 订舱品名、船名、船次必填
        if (this.curProcessOrder === 4 && 
        this.processInfo.nodeInfo[this.curProcessOrder].nodeName !== '知会单证') {
          if (this.isReorderType) {
            // 如果是 "重新订舱" 类型，不做验证
          } else {
    ...
    // async changeOrder() {
    //   await shipCabinOrderServer.changeOrder({
    //     bookingId: this.formData.oldBookingId,
    //     warnId: this.formData.warnId
    //   })
    //   this.$message({
    //     message: '变更成功',
    ...
    // },
    // async cancelOrder() {
    //   await shipCabinOrderServer.cancelChange({
    //     oldBookingId: this.formData.oldBookingId,
    //     bookingId: this.formData.bookingId
    //   })
    //   this.$message({
    ...
    processStep2() {
      ...
      if (this.formData.isChange === 2) {
        this.isDisable2 = false
        this.rules.departDate = this.rules.cutDate = this.rules.cutoffDate = {
          required: true,
          message: '不能为空',
          trigger: 'blur'
        }
          ...
          this.rules.departDate = [
            {
              ...
              validator: (rule, value, callback) => {
                if (
                  ...
                  if (
                    this.formData.departDate && this.formData.cutDate &&
                    Date.parse(this.formData.departDate) <
                    Date.parse(this.formData.cutDate)
                  ) {
                    return callback(new Error('开船日期必须大于截关日期'))
                  }
                }
                callback()
              }
              ...
              validator: (rule, value, callback) => {
                if (
                  ...
                  if (
                    ...
                    this.formData.cutoffDate && this.formData.cutDate &&
              ...
              validator: (rule, value, callback) => {
                if (
                  ...
                  if (
                    ...
                    callback(new Error('截单日期须小于等于截关日期'))
                    return
                  }
                }
                callback()
            ...
            validator: (rule, value, callback) => {
              if (
                ...
                if (
                  ...
                  this.formData.cutoffDate && this.formData.cutDate && Date.parse(this.formData.cutoffDate) > ((Date.parse(this.formData.cutDate) + (16 * 60 * 60 * 1000 - 1)))) {
                  return callback(new Error('截关日期须大于等于截单日期'))
                }
              }
              callback()
    ...
    processStep6() {
      ...
      // 如果 this.formData.isChange 类型为 4，就不需要任何校验
      if (this.formData.isChange !== 4) {
        // 变更类型为“重新订舱”时，船公司、船名、船次、提单号、是否放舱可编辑且是必填字段
        if (this.isReorderType) {
          this.rules.cutoffDate = 
          this.rules.towCopName = 
          this.rules.shipName = 
          this.rules.saillings = 
          this.rules.billNo = 
          this.rules.isFc = {
            required: true,
            message: '不能为空',
    ...
    processStep7() {
      ...
      // 如果 this.formData.isChange 类型为 4，就不需要任何校验
      if (this.formData.isChange !== 4) {
        // 变更类型为“重新订舱”时，箱号、封号、空箱重量可编辑，且是必填字段
        if (this.isReorderType) {
          this.rules.actualBoxNos = this.rules.emptyBoxWeight = this.rules.seals = {
            required: true,
            message: '不能为空',
            trigger: 'blur'
          }
      ...
      this.$confirm('订舱单是否变更？', '提示', {
        ...
        .then(async() => {
          try {
            ...
            this.$router.push({
              path: '../../ship-cabin-order-change/detail/' + res.data.data.bookingId
            })
          } finally {
            this.loading = false
          }
