      ...
      <el-row>
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="型号">
            <el-input v-model="keyword.type" size="mini" />
          </el-form-item>
        </el-col>
    ...
    >
      <div>
        <el-row>
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.type">型号</el-checkbox>
          </el-col>
          <el-col :span="24">
...
export default {
  name: 'MachineTypeManagement',
  components: {
    ExportPopup: () => import('./../../../components/excel/ExportPopup.vue'),
    MachineTypeViewPopup: () => import('./machineTypeViewPopup.vue'),
    MachineTypeEditPopup: () => import('./machineTypeEditPopup.vue'),
    MachineTypeDeletePopup: () => import('./machineTypeDeletePopup.vue')
  },
  filters: {
  },
  data() {
  ...
  methods: {
    async search() {
      ...
      const res = await machineTypeServer.search({
        query,
        page: this.page - 1,
        size: this.size
      })
