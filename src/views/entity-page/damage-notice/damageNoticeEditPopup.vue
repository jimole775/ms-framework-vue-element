<template>
  <div>
    <el-dialog
      ...
      :title="id ? '可损通知-edit' : 'new-可损通知'"
      top="10vh"
      @close="close"
    >
      <div>
        <DamageNoticeEdit ref="damageNoticeEdit" :id="id" @loadingChange="loadingChange" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async save() {
      const formData = await this.$refs.damageNoticeEdit.save()
