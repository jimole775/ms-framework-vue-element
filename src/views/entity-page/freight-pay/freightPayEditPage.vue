<template>
  <div class="container">
    <FreightPayEdit ref="freightPayEdit" :id="id" @loadingChange="loadingChange" />    
    <div class="max-w">
      <div class="f-r">
...
<script>
import FreightPayEdit from './../../../components/entity/freight-pay/FreightPayEdit'
export default {
  name: 'FreightPayEditPage',
  components: {
    FreightPayEdit
  },
  data() {
