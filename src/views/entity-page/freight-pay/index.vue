      ...
      <el-row>
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="状态">
            <FeePayStatEnumSelect v-model="keyword.stats" type="multiple"/>
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="协议货代">
            ...
            <!-- <ShippingCompanySelect v-model="keyword.transitIds" /> -->
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="供应商">
            <el-input v-model="keyword.venderName" size="mini"/>
            <!-- <CustomerSelect v-model="keyword.venderIds" /> -->
          </el-form-item>
        </el-col>
    ...
    <el-dialog :visible="showEye" width="360px" title="过滤" top="10vh" @close="showEye = false">
      <div>
        <el-row>
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.sapNo">凭证号</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.venderName">供应商</el-checkbox>
          </el-col>
        </el-row>
      </div>
    </el-dialog>
...
export default {
  ...
  components: {
    ...
    PayTypeEnumSelect,
    CompCodeEnumSelect,
    FreightPayViewPopup: () => import('./freightPayViewPopup.vue'),
    FreightPayEditPopup: () => import('./freightPayEditPopup.vue'),
    FreightPayDeletePopup: () => import('./freightPayDeletePopup.vue')
  },
  filters: {
  ...
  methods: {
    async search() {
      ...
      const res = await freightPayServer.search({
        keyword,
        page: this.page - 1,
        size: this.size
      })
    ...
    clickEditBtn(row) {
      ...
      this.$router.push({
        path: './freight-pay-edit/' + row.payId
        // query: { id: row.payId }
      })
    },
    clickAddBtn() {
