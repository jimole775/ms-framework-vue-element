<template>
  <div>
          ...
          <el-tab-pane label="基础">
            <el-form :inline="true" class="demo-form-inline">
              <el-row>
                ...
                <el-col :lg="4" :md="5" :sm="8" :xs="17" class="data-col-content">
                  {{ viewData.status | CustomConfirmStatusFilter }}
                </el-col>
                <el-col :lg="2" :md="3" :sm="4" :xs="7" class="data-col-title">
                  商业发票号:
                </el-col>
                ...
                <el-col :lg="4" :md="5" :sm="8" :xs="17" class="data-col-content">
                  <el-tag :type="viewData.needModify === true ? 'success' : 'danger'">
                    {{ viewData.needModify === true ? '是' : '否' }}
                  </el-tag>
                </el-col>
                <el-col :lg="2" :md="3" :sm="4" :xs="7" class="data-col-title">
                  是否删除:
    ...
    <component v-if="showEdit" :is="'CustomConfirmEditPopup'" :id="id" @close="showEdit = false" />
    <component
...
export default {
  ...
  methods: {
    ...
    async getData() {
      const res = await customConfirmServer.get(this.id)
