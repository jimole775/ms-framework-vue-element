      ...
      <el-row>
        ...
        <el-col :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="货币符号">
            <el-input v-model="keyword.symbol" size="mini" />
          </el-form-item>
        </el-col>
    ...
    >
      <div>
        <el-row>
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.symbol">货币符号</el-checkbox>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  components: {
    ...
    CurrencyViewPopup: () => import('./currencyViewPopup.vue'),
    CurrencyEditPopup: () => import('./currencyEditPopup.vue'),
    CurrencyDeletePopup: () => import('./currencyDeletePopup.vue')
  },
  filters: {
  },
  data() {
  ...
  methods: {
    async search() {
      ...
      if (Validate.isNotEmpty(keyword.symbol)) {
        query += ` AND symbol:${keyword.symbol}`
      }
      const res = await currencyServer.search({
        query,
        page: this.page - 1,
        size: this.size
      })
