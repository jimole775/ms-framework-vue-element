      ...
      <el-row>
        <el-col :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="信用证申请人">
            <el-input v-model="keyword.proposer" size="mini" />
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="8" :sm="12" :xs="24">
        ...
        <el-col :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="信用证号">
            <el-input v-model="keyword.creditCloseCode" size="mini" />
          </el-form-item>
        </el-col>
        ...
        <!-- <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="信用证日期起始">
            <el-date-picker
              v-model="keyword.creditCertificateDateStart"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="信用证日期结束">
            <el-date-picker
              v-model="keyword.creditCertificateDateEnd"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收证日期起始">
            <el-date-picker
              v-model="keyword.receivedCreditCertificateDateStart"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收证日期结束">
            <el-date-picker
              v-model="keyword.receivedCreditCertificateDateEnd"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="状态">
            <CreditCertificateStatusEnumSelect v-model="keyword.status" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="最迟装运日起始">
            <el-date-picker
              v-model="keyword.lastLoadDateStart"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="最迟装运日结束">
            <el-date-picker
              v-model="keyword.lastLoadDateEnd"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="付款方式">
            <CreditCertificatePayWayEnumSelect v-model="keyword.payWay" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="上浮比率(%)">
            <el-input v-model="keyword.upFloatRate" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="上浮后金额">
            <el-input v-model="keyword.upFloatedAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="实际金额">
            <el-input v-model="keyword.actualAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="已分配金额">
            <el-input v-model="keyword.allocatedAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="未分配金额">
            <el-input v-model="keyword.distributableAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="已发货金额">
            <el-input v-model="keyword.deliveredAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="已交单金额">
            <el-input v-model="keyword.closeBillAmount" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="到期地点">
            <el-input v-model="keyword.expireAddress" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="交单期限">
            <el-input v-model="keyword.closeBillDeadline" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="产地证">
            <CreditCertificatePlaceOfOriginCertificateEnumSelect v-model="keyword.placeOfOriginCertificate" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="回款期限">
            <el-input v-model="keyword.returnedMoneyDeadline" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="回款时点">
            <CreditCertificatePointTimeEnumSelect v-model="keyword.pointTime" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="改证信息">
            <el-input v-model="keyword.alterCertificateInformation" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="建议修改信息">
            <el-input v-model="keyword.suggestedModificationInformation" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="业务反馈信息">
            <el-input v-model="keyword.businessFeedback" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="需业务提供单据">
            <el-input v-model="keyword.businessDocuments" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人">
            <el-input v-model="keyword.consignorName" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人地址">
            <el-input v-model="keyword.consignorAddress" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人电话">
            <el-input v-model="keyword.consignorTel" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人传真">
            <el-input v-model="keyword.consignorFax" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人邮箱">
            <el-input v-model="keyword.consignorEmail" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人企业代码">
            <el-input v-model="keyword.consignorEnterpriseCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人国家代码">
            <el-input v-model="keyword.consignorCountryCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="发货人AEO编码">
            <el-input v-model="keyword.consignorAeoCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人">
            <el-input v-model="keyword.consigneeName" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人地址">
            <el-input v-model="keyword.consigneeAddress" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人电话">
            <el-input v-model="keyword.consigneeTel" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人传真">
            <el-input v-model="keyword.consigneeFax" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人邮箱">
            <el-input v-model="keyword.consigneeEmail" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人企业代码">
            <el-input v-model="keyword.consigneeEnterpriseCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人国家代码">
            <el-input v-model="keyword.consigneeCountryCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="收货人AEO编码">
            <el-input v-model="keyword.consigneeAeoCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="具体联系人名称">
            <el-input v-model="keyword.consigneeContactName" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="具体联系人电话">
            <el-input v-model="keyword.consigneeContactTel" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="具体联系人传真">
            <el-input v-model="keyword.consigneeContactFax" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="具体联系人邮箱">
            <el-input v-model="keyword.consigneeContactEmail" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人">
            <el-input v-model="keyword.notifyName" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人地址">
            <el-input v-model="keyword.notifyAddress" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人电话">
            <el-input v-model="keyword.notifyTel" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人传真">
            <el-input v-model="keyword.notifyFax" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人邮箱">
            <el-input v-model="keyword.notifyEmail" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人企业代码">
            <el-input v-model="keyword.notifyEnterpriseCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人国家代码">
            <el-input v-model="keyword.notifyCountryCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知人AEO编码">
            <el-input v-model="keyword.notifyAeoCode" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="其它通知人">
            <el-input v-model="keyword.otherNotifyMan" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="LC受益人">
            <el-input v-model="keyword.lc" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="船证明">
            <el-input v-model="keyword.shipCertificate" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="加注信息">
            <el-input v-model="keyword.supplementInfo" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="其他">
            <el-input v-model="keyword.other" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="业务方式">
            <CreditCertificateBusinessWayEnumSelect v-model="keyword.businessWay" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="信用证类型">
            <CreditCertificateTypeEnumSelect v-model="keyword.creditCertificateType" type="multiple" />            
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="正本通知费">
            <el-input v-model="keyword.noticeCost" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="不符点费">
            <el-input v-model="keyword.pointTimeNotMatchCost" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="确认人">
            <el-input v-model="keyword.confirmMan" size="mini" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="确认时间起始">
            <el-date-picker
              v-model="keyword.confirmTimeStart"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="确认时间结束">
            <el-date-picker
              v-model="keyword.confirmTimeEnd"
              size="mini"
              class="max-w"
              type="datetime"
            />
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="通知银行">
            <BankSelect v-model="keyword.noticeBankIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="议付银行">
            <BankSelect v-model="keyword.paymentBankIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="开证银行">
            <BankSelect v-model="keyword.proveBankIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="出货港">
            <PortSelect v-model="keyword.sendPortIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="到货港">
            <PortSelect v-model="keyword.targetPortIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
        ...
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="福费廷银行">
            <BankSelect v-model="keyword.forfaitingBankIds" type="multiple" />
          </el-form-item>
        </el-col>
        <el-col v-show="more" :lg="6" :md="8" :sm="12" :xs="24">
          <el-form-item label="保兑银行">
            <BankSelect v-model="keyword.confirmingBankIds" type="multiple" />
          </el-form-item>
        </el-col> -->
      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{ scope.row.creditCertificateDate | parseTime('{y}-{m}-{d}') }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.receivedCreditCloseDate"
          show-overflow-tooltip
          ...
          label="收证日期">
          <template slot-scope="scope">
            {{ scope.row.receivedCreditCertificateDate | parseTime('{y}-{m}-{d}') }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.status"
          ...
          label="状态">
          <template slot-scope="scope">
            {{ scope.row.status | CreditCertificateStatusFilter }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.creditCloseCode"
          show-overflow-tooltip
        ...
        <el-table-column
          ...
          label="最迟装运日">
          <template slot-scope="scope">
            {{ scope.row.lastLoadDate | parseTime('{y}-{m}-{d}') }}
          </template>
        </el-table-column>
        <el-table-column
          ...
          label="有效期">
          <template slot-scope="scope">
            {{ scope.row.periodValidity | parseTime('{y}-{m}-{d}') }}
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          label="付款方式">
          <template slot-scope="scope">
            {{ scope.row.payWay | CreditCertificatePayWayFilter }}
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          label="产地证">
          <template slot-scope="scope">
            {{ scope.row.placeOfOriginCertificate | CreditCertificatePlaceOfOriginCertificateFilter }}
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          label="回款时点">
          <template slot-scope="scope">
            {{ scope.row.pointTime | CreditCertificatePointTimeFilter }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.alterCloseInformation"
          show-overflow-tooltip
        ...
        <el-table-column
          ...
          label="业务方式">
          <template slot-scope="scope">
            {{ scope.row.businessWay | CreditCertificateBusinessWayFilter }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.creditCloseType"
          show-overflow-tooltip
          ...
          label="信用证类型">
          <template slot-scope="scope">
            {{ scope.row.creditCertificateType | CreditCertificateTypeFilter }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.noticeCost"
        ...
        <el-table-column
          ...
          label="确认时间">
          <template slot-scope="scope">
            {{ scope.row.confirmTime | parseTime('{y}-{m}-{d}') }}
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.isConfirm"
    ...
    >
      <div>
        <el-row>
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.creditCloseDate">信用证日期</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.receivedCreditCloseDate">收证日期</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.status">状态</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.creditCloseCode">信用证号</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.proposer">申请人</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.placeOfOriginClose">产地证</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.alterCloseInformation">改证信息</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.shipClose">船证明</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.creditCloseType">信用证类型</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.enable">有效</el-checkbox>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  components: {
    ...
    TradeDocumenterViewPopup: () => import('./../trade-documenter/tradeDocumenterViewPopup'),
    OperateUnitSelect,
    BankSelect,
  ...
  filters: {
    ...
    CreditCertificatePayWayFilter: CreditCertificatePayWayEnumUtil.toTitleFilter,
    CreditCertificatePlaceOfOriginCertificateFilter: CreditCertificatePlaceOfOriginCertificateEnumUtil.toTitleFilter,
    CreditCertificatePointTimeFilter: CreditCertificatePointTimeEnumUtil.toTitleFilter,
    CreditCertificateBusinessWayFilter: CreditCertificateBusinessWayEnumUtil.toTitleFilter,
  ...
  data() {
    return {
      ...
      eye: {
        code: true,
        creditCloseDate: true,
        receivedCreditCloseDate: true,
        status: true,
        creditCloseCode: true,
        proposer: true,
        lastLoadDate: true,
        periodValidity: true,
        ...
        placeOfOriginClose: true,
        returnedMoneyDeadline: true,
        pointTime: true,
        alterCloseInformation: true,
  ...
  methods: {
    ...
    clickExportBtn() {
      ...
      this.dataExport.forEach(item => {
        ...
        item.placeOfOriginCertificate = CreditCertificatePlaceOfOriginCertificateEnumUtil.toTitleFilter(item.placeOfOriginCertificate)
        item.pointTime = CreditCertificatePointTimeEnumUtil.toTitleFilter(item.pointTime)
        item.businessWay = CreditCertificateBusinessWayEnumUtil.toTitleFilter(item.businessWay)
        item.creditCertificateType = CreditCertificateTypeEnumUtil.toTitleFilter(item.creditCertificateType)
