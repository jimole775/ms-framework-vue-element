  ...
  <div class="container">
    ...
    <template>
      ...
      >
        ...
        <el-table-column
          v-if="eye.receivedCreditChangeDate"
          show-overflow-tooltip
        ...
        <el-table-column
          ...
          label="状态"
        >
          <template slot-scope="scope">{{ scope.row.status | CreditCertificateStatusFilter }}</template>
        </el-table-column>
        <el-table-column
          v-if="eye.creditChangeCode"
          show-overflow-tooltip
        ...
        <el-table-column
          ...
          label="付款方式"
        >
          <template slot-scope="scope">{{ scope.row.payWay | CreditCertificatePayWayFilter }}</template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template
            slot-scope="scope"
          >{{ scope.row.placeOfOriginChange | CreditCertificatePlaceOfOriginCertificateFilter }}</template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          v-if="eye.alterChangeInformation"
          show-overflow-tooltip
    ...
    <el-dialog :visible="showEye" width="360px" title="过滤" top="10vh" @close="showEye = false">
      <div>
        <el-row>
          <el-col :span="24">
            <el-checkbox v-model="eye.changeNo">变更单号</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.code">水单编号</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.creditChangeDate">信用证日期</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.receivedCreditChangeDate">收证日期</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.status">状态</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.creditChangeCode">信用证号</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.placeOfOriginChange">产地证</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.alterChangeInformation">改证信息</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.shipChange">船证明</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.creditChangeType">信用证类型</el-checkbox>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  components: {
    ...
    CreditChangeDeletePopup: () => import('./creditChangeDeletePopup.vue')
  },
  filters: {
  ...
  data() {
    return {
      ...
      eye: {
        changeNo: true,
        code: true,
        creditChangeDate: true,
        receivedCreditChangeDate: true,
        status: true,
        creditChangeCode: true,
        lcReqMan: true,
        lastLoadDate: true,
        periodValidity: true,
        ...
        placeOfOriginChange: true,
        returnedMoneyDeadline: true,
        pointTime: true,
        alterChangeInformation: true,
  ...
  methods: {
    async search() {
      ...
      const res = await creditChangeServer.search({
        keyword,
        page: this.page - 1,
        size: this.size
      })
    ...
    handleRowDb(row) {
      this.$router.push({
        path: './credit-change/edit/' + row.id
      })
    },
    clickAddBtn() {
      this.$router.push({
        path: './credit-change/edit/new'
      })
      this.reload()
    },
    clickBatchDeleteBtn() {
      if (this.multipleSelection.length > 0) {
        ...
        this.multipleSelection.forEach((item) => {
          if (Number.parseInt(item.stat) !== 1) {
            isPass = false
          } 
        })

        if (isPass) this.showDeletePopup = true
        else {
 this.$message({
          message: '非制单状态的单据不可删除，请重新选择',
          type: 'warning'
        }) 
}
      } else {
