<template>
  <div>
          ...
          <el-tab-pane label="基础">
            <el-form :inline="true" class="demo-form-inline">
              <el-row>
                ...
                <el-col :lg="4" :md="5" :sm="8" :xs="17" class="data-col-content">
                  {{ viewData.status | FreightStandardStatusFilter }}
                </el-col>
                <el-col :lg="2" :md="3" :sm="4" :xs="7" class="data-col-title">
                  备注:
                </el-col>
    ...
    <component v-if="showEdit" :is="'FreightStandardEditPopup'" :id="id" @close="showEdit = false" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      const res = await freightStandardServer.get(this.id)
