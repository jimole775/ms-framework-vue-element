...
export default {
  name: 'OperateUnitManagement',
  components: {
    ExportPopup: () => import('./../../../components/excel/ExportPopup.vue'),
    OperateUnitViewPopup: () => import('./operateUnitViewPopup.vue'),
    OperateUnitEditPopup: () => import('./operateUnitEditPopup.vue'),
    OperateUnitDeletePopup: () => import('./operateUnitDeletePopup.vue')
  },
  filters: {
  },
  data() {
  ...
  methods: {
    async search() {
      ...
      const res = await operateUnitServer.search({
        query,
        page: this.page - 1,
        size: this.size
      })
