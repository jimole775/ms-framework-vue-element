<template>
  <div>
    <el-dialog
      ...
      :title="id ? '费用登记-edit' : 'new-费用登记'"
      top="10vh"
      @close="close"
    >
      <div>
        <ExpenseRecordEdit ref="expenseRecordEdit" :id="id" @loadingChange="loadingChange" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async save() {
      const formData = await this.$refs.expenseRecordEdit.save()
