    ...
    <template>
      ...
      >
        ...
        >
          <template
            slot-scope="scope"
          >{{ scope.row.shipmentDate | parseTime('{y}-{m}-{d} {h}:{i}') }}</template>
        </el-table-column>
        <el-table-column
        ...
        />
        <el-table-column
          v-if="eye.transportationMode"
          show-overflow-tooltip
          prop="transportationMode"
          sortable
          min-width="115"
          label="运输方式"
        >
          <template
            slot-scope="scope"
          >{{ scope.row.transportationMode | DeliverReportTransportationModeFilter }}</template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template
            slot-scope="scope"
          >{{ scope.row.paymentMethod | DeliverReportPaymentMethodFilter }}</template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <el-button
              type="text"
              size="mini"
              @click="openBuyCustomerViewPopup(scope.row.buyCustomerId)"
            >{{ scope.row.buyCustomer ? scope.row.buyCustomer.id : '' }}</el-button>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <el-button
              type="text"
              size="mini"
              @click="openDepartmentViewPopup(scope.row.departmentId)"
            >{{ scope.row.department ? scope.row.department.id : '' }}</el-button>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <el-button
              type="text"
              size="mini"
              @click="openCommercialInvoiceViewPopup(scope.row.commercialInvoiceId)"
            >{{ scope.row.commercialInvoice ? scope.row.commercialInvoice.id : '' }}</el-button>
          </template>
        </el-table-column>
        <el-table-column
          v-if="eye.currencyId"
        ...
        >
          <template slot-scope="scope">
            <el-button
              type="text"
              size="mini"
              @click="openCurrencyViewPopup(scope.row.currencyId)"
            >{{ scope.row.currency ? scope.row.currency.id : '' }}</el-button>
          </template>
        </el-table-column>
        <!-- <el-table-column
          fixed="right"
    ...
    <el-dialog :visible="showEye" width="360px" title="过滤" top="10vh" @close="showEye = false">
      <div>
        <el-row>
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.shipmentDate">出运日期</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.transportationMode">运输方式</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.paymentMethod">缴费支付方式</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.buyCustomerId">买方</el-checkbox>
          </el-col>
          <el-col :span="24">
            <el-checkbox v-model="eye.departmentId">经营单位</el-checkbox>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-checkbox v-model="eye.currencyId">出运货币代码</el-checkbox>
          </el-col>
        </el-row>
      </div>
    </el-dialog>
...
export default {
  ...
  components: {
    ...
    DeliverChangeViewPopup: () => import('./deliverChangeViewPopup.vue'),
    DeliverChangeEditPopup: () => import('./deliverChangeEditPopup.vue'),
    DeliverChangeDeletePopup: () => import('./deliverChangeDeletePopup.vue')
  ...
  methods: {
    async search() {
      ...
      const res = await deliverChangeServer.search({
        keyword,
        page: this.page - 1,
        size: this.size
      })
    ...
    clickExportBtn() {
      ...
      this.dataExport.forEach(item => {
        ...
        item.transportationMode = DeliverReportTransportationModeEnumUtil.toTitleFilter(item.transportationMode)
      })  
      this.setExportData()
