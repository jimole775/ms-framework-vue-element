...
export default {
  ...
  components: {
    ...
    ContainerViewPopup: () => import('./containerViewPopup.vue'),
    ContainerEditPopup: () => import('./containerEditPopup.vue'),
    ContainerDeletePopup: () => import('./containerDeletePopup.vue')
  },
  filters: {
  },
  data() {
