<template>
  <div>
    <el-dialog
      ...
      :title="id ? '融资登记-edit' : 'new-融资登记'"
      top="10vh"
      @close="close"
    >
      <div>
        <FinancingRegistrationEdit ref="financingRegistrationEdit" :id="id" @loadingChange="loadingChange" />
      </div>
...
export default {
  name: 'FinancingRegistrationEditPopup',
  components: {
  ...
  methods: {
    ...
    async save() {
      const formData = await this.$refs.financingRegistrationEdit.save()
