<template>
  <div>
          ...
          <el-tab-pane label="基础">
            <el-form :inline="true" class="demo-form-inline">
              <el-row>
                ...
                <el-col :lg="4" :md="5" :sm="8" :xs="17" class="data-col-content">
                  {{ viewData.status | FreightAdvanceStatusFilter }}
                </el-col>
                <el-col :lg="2" :md="3" :sm="4" :xs="7" class="data-col-title">
                  总金额:
                </el-col>
    ...
    <component v-if="showEdit" :is="'FreightAdvanceEditPopup'" :id="id" @close="showEdit = false" />
    <component
...
export default {
  ...
  methods: {
    ...
    async getData() {
      const res = await freightAdvanceServer.get(this.id)
