<template>
  <div>
    ...
    <component v-if="showEdit" :is="'ClearanceManualProductEditPopup'" :id="id" @close="showEdit = false" />
    <component
...
export default {
  name: 'ClearanceManualProductViewPopup',
  components: {
  ...
  methods: {
    ...
    async getData() {
      const res = await clearanceManualProductServer.get(this.id)
