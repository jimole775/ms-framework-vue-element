<template>
  <div class="container">
    ...
    <component
      v-if="showViewPopup"
      :is="'ClearanceManualProductViewPopup'"
      :id="currentClickRow.id"
      @close="showViewPopup = false"
    />
    <component
      v-if="showEditPopup"
      :is="'ClearanceManualProductEditPopup'"
      :id="currentClickRow.id"
...
import UomEnumSelect from './../../../components/entity/clearance-manual-product/UomEnumSelect'
import UomEnumUtil from './../../../components/enum/clearance-manual-product/UomEnumUtil'
import StdUomEnumSelect from './../../../components/entity/clearance-manual-product/StdUomEnumSelect'
import StdUomEnumUtil from './../../../components/enum/clearance-manual-product/StdUomEnumUtil'
import CnyEnumSelect from './../../../components/entity/clearance-manual-product/CnyEnumSelect'
import CnyEnumUtil from './../../../components/enum/clearance-manual-product/CnyEnumUtil'
...
export default {
  name: 'ClearanceManualProductManagement',
  components: {
    ...
    StdUomEnumSelect,
    CnyEnumSelect,
    ClearanceManualProductViewPopup: () => import('./clearanceManualProductViewPopup.vue'),
    ClearanceManualProductEditPopup: () => import('./clearanceManualProductEditPopup.vue'),
    ClearanceManualProductDeletePopup: () => import('./clearanceManualProductDeletePopup.vue')
  },
  filters: {
  ...
  methods: {
    async search() {
      ...
      const res = await clearanceManualProductServer.search({
        query,
        page: this.page - 1,
        size: this.size
      })
