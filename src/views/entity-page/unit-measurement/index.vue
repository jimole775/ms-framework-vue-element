...
export default {
  name: 'UnitMeasurementManagement',
  components: {
    ExportPopup: () => import('./../../../components/excel/ExportPopup.vue'),
    UnitMeasurementViewPopup: () => import('./unitMeasurementViewPopup.vue'),
    UnitMeasurementEditPopup: () => import('./unitMeasurementEditPopup.vue'),
    UnitMeasurementDeletePopup: () => import('./unitMeasurementDeletePopup.vue')
  },
  filters: {
  },
  data() {
  ...
  methods: {
    async search() {
      ...
      const res = await unitMeasurementServer.search({
        query,
        page: this.page - 1,
        size: this.size
      })
